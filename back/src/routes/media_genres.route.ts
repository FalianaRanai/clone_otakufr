...
import { CreateMediaGenreDto, UpdateMediaGenreDto } from '@dtos/media_genres.dto';
...
export class MediaGenreRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/generate`, this.media_genre.generate);
    this.router.put(`${this.path}/:id(\\d+)`, ValidationMiddleware(UpdateMediaGenreDto, true), this.media_genre.updateMediaGenre);
